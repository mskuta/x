* `apache2-defaultpage.yaml` - Ansible playbook to replace the default page of the Apache HTTP Server on Debian to not reveal the used web server and Linux distribution.
